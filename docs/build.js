...
const versions = getDirectories('./ML-Transformers/BackgroundEnchantments/versions');
...
fs.writeFileSync("./ML-Transformers/BackgroundEnchantments/versions/index.html", versionListHtml, 'utf8');
